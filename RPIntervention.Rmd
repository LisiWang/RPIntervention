...
PMK_OE_LW <- read.csv("PMK_OE_LW.csv")
head(PMK_OE_LW)
str(PMK_OE_LW)
names(PMK_OE_LW)

PMK_OE_RA <- read.csv("PMK_OE_RA.csv")
head(PMK_OE_RA)
str(PMK_OE_RA)
names(PMK_OE_RA)
```
...
PMK_OE_LW <- PMK_OE_LW %>%
  mutate(typical_LW=(flashcards_LW+practicetests_LW),
         ...
         general_LW=(activeretrieve_LW+assignments_LW+structure_LW+prompts_LW+freerecall_LW+selfexplain_LW+nonexperts_LW+experts_LW),
         general_D_LW=(activeretrieve_D_LW+assignments_D_LW+structure_D_LW+prompts_D_LW+freerecall_D_LW+selfexplain_D_LW+nonexperts_D_LW+experts_D_LW))
PMK_OE_LW$typical_LW
PMK_OE_LW$typical_D_LW
PMK_OE_LW$general_LW
PMK_OE_LW$general_D_LW

# RP
PMK_OE_RA <- PMK_OE_RA %>%
  mutate(typical_RA=(flashcards_RA+practicetests_RA),
         general_RA=(activeretrieve_RA+assignments_RA+structure_RA+prompts_RA+freerecall_RA+selfexplain_RA+nonexperts_RA+experts_RA))
PMK_OE_RA$typical_RA
PMK_OE_RA$general_RA

# remove repeated col other than unique
names(PMK_OE_RA)
PMK_OE_RA <- PMK_OE_RA %>% dplyr::select(-PMK_OE)
names(PMK_OE_RA)

# combine df
PMK_OE_Combined <- dplyr::inner_join(PMK_OE_LW, PMK_OE_RA, by = "unique")
names(PMK_OE_Combined)

# ------ irr ------
kappa2(PMK_OE_Combined[, c("flashcards_LW", "flashcards_RA")], weight = "unweighted") # 0.98
kappa2(PMK_OE_Combined[, c("practicetests_LW", "practicetests_RA")], weight = "unweighted") # 0.71
kappa2(PMK_OE_Combined[, c("activeretrieve_LW", "activeretrieve_RA")], weight = "unweighted") # 0.79
kappa2(PMK_OE_Combined[, c("assignments_LW", "assignments_RA")], weight = "unweighted") # 0.82
kappa2(PMK_OE_Combined[, c("structure_LW", "structure_RA")], weight = "unweighted") # 0.80
kappa2(PMK_OE_Combined[, c("prompts_LW", "prompts_RA")], weight = "unweighted") # 0.42
kappa2(PMK_OE_Combined[, c("freerecall_LW", "freerecall_RA")], weight = "unweighted") # 0.73
kappa2(PMK_OE_Combined[, c("selfexplain_LW", "selfexplain_RA")], weight = "unweighted") # 0.58
kappa2(PMK_OE_Combined[, c("nonexperts_LW", "nonexperts_RA")], weight = "unweighted") # 0.90
kappa2(PMK_OE_Combined[, c("experts_LW", "experts_RA")], weight = "unweighted") # 0.85

icc(PMK_OE_Combined[, c("typical_LW", "typical_RA")], model = "twoway", type = "agreement", unit = "single") # 0.88 [0.85, 0.90]
icc(PMK_OE_Combined[, c("general_LW", "general_RA")], model = "twoway", type = "agreement", unit = "single") # 0.86 [0.83, 0.89]
```
